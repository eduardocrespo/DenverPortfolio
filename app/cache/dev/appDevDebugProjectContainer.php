...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FreelanceDenverPortfolioBundle', ($this->targetDirs[2].'/Resources/FreelanceDenverPortfolioBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FreelanceDenverPortfolioBundle', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'EqIn$@a1l', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Admin/AdminBundle/Resources/config/doctrine') => 'Admin\\AdminBundle\\Entity'));
        ...
        $c->addDriver($a, 'Admin\\AdminBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AdminAdminBundle' => 'Admin\\AdminBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a98c82739815600128aac707a8f6b0ac56570ac891ba11eff7edc3766f5f2798');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.post', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.post')), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group'))));
        $instance->setAdminClasses(array('Admin\\AdminBundle\\Entity\\Video' => array(0 => 'sonata.admin.post'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
     ...
     *
     * @return \Admin\AdminBundle\Admin\VideoAdmin A Admin\AdminBundle\Admin\VideoAdmin instance.
     */
    protected function getSonata_Admin_PostService()
    {
        $instance = new \Admin\AdminBundle\Admin\VideoAdmin('sonata.admin.post', 'Admin\\AdminBundle\\Entity\\Video', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.post', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'), $this);
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.block.service.text', 1 => 'sonata.block.service.rss', 2 => 'sonata.user.block.menu', 3 => 'sonata.user.block.account', 4 => 'sonata.admin.block.admin_list', 5 => 'sonata.admin.block.search_result'));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.sk.xliff'), 'sk', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.ru.xliff'), 'ru', 'SonataUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.en.yml'), 'en', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.fr.xliff'), 'fr', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.de.xliff'), 'de', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.es.xliff'), 'es', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.sl.xliff'), 'sl', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.ca.xliff'), 'ca', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.nl.xliff'), 'nl', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.pt.xliff'), 'pt', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.zh_TW.xliff'), 'zh_TW', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.it.xliff'), 'it', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.lt.xliff'), 'lt', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.cs.xliff'), 'cs', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.fa.xliff'), 'fa', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.pl.xliff'), 'pl', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.pt_BR.xliff'), 'pt_BR', 'SonataUserBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/translations/SonataUserBundle.bg.xliff'), 'bg', 'SonataUserBundle');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FreelanceDenverPortfolioBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Freelance/DenverPortfolioBundle/Resources/views'), 'FreelanceDenverPortfolio');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('A2k!%20');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FreelanceDenverPortfolioBundle' => 'Freelance\\DenverPortfolioBundle\\FreelanceDenverPortfolioBundle',
            ...
            'assetic.bundles' => array(
                0 => 'FreelanceDenverPortfolioBundle',
            ),
